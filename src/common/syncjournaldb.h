...
public:
    ...
    struct UploadInfo
    {
        ...
        /**
         * Returns true if this entry reffer to a chunked upload that can be continued.
         * (As oposed to a small file transfer which is stored in the db so we can detect the case
